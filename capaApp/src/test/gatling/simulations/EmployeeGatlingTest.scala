...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .post("/api/employees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "dayRate":null, "shortName":"SAMPLE_TEXT", "shore":"SAMPLE_TEXT", "grade":"SAMPLE_TEXT", "projectAvailability":null, "internProjectAvailability":null, "formDate":"2020-01-01T00:00:00.000Z", "toDate":"2020-01-01T00:00:00.000Z", "capacityPA":null, "capacityIPA":null, "country":null, "team":null}""")).asJSON
            .check(status.is(201))
