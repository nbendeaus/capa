...
import de.capgemini.capa.domain.enumeration.Country;
...
public class EmployeeResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_FORM_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_FORM_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].formDate").value(hasItem(sameInstant(DEFAULT_FORM_DATE))))
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.formDate").value(sameInstant(DEFAULT_FORM_DATE)))
