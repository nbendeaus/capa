...
@EnableZuulProxy
public class CapaApp {

    private static final Logger log = LoggerFactory.getLogger(CapaApp.class);

    private final Environment env;

    public CapaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CapaApp.class);
